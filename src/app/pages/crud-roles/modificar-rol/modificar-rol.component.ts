...
@Component({
  ...
  imports: [ButtonModule,CommonModule,FormsModule,DragDropModule,
    CheckboxModule,DialogModule,InputTextModule,InputGroupModule],
  templateUrl: './modificar-rol.component.html',
  styleUrl: './modificar-rol.component.css'
})
export class ModificarRolComponent extends ModalBaseController {
  obj:Rol;
  ...
  add_sub_menu_text!:string;
     constructor(httpclient:HttpClient,private rolService:RolService){
       ...
       inicializar(mostrar=true,rol:Rol){
         this.obj=rol;
         this.ver=mostrar;
       }
       onDropGral(data:any){
